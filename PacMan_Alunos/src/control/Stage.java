...
public class Stage extends javax.swing.JFrame implements KeyListener {
    ...
    File arquivo = new File("map"+faseAtual+".txt");
    private final char map[][] = leitura(arquivo);
    ...
    public void paint(Graphics gOld) {
        ...
        if(Consts.vidas>5)
        {
            String vida= Integer.toString(Consts.vidas);
            g2.setColor(Color.WHITE);
            g2.setFont(new Font(("Comics Sans"),Font.BOLD,20));
            g2.drawString(vida, 100, 35);
        }
        if(Consts.vidas==5)
        {
